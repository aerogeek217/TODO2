...
| Todo2Database | data/database.ts | Dexie DB class with schema (v16 base + v17/v18/v19 incremental + v20 unified status + v21 unified scheduling + v22 list-definitions builder DSL; v1-v15 collapsed) |
...
| ListDefinitionPickerPopup | components/overlays/ListDefinitionPickerPopup.tsx | Portal-rendered popover triggered by the Dashboard "+" tile; lists unpinned list definitions with a Pin action and a "Create new list…" button that opens `DashboardListsEditor` |
