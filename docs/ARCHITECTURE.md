...
│   ├── task/              → TaskRow + MobileTaskRow (mount the shared `TagChipSelector` after the pill bar — `#tag` chips inline + lookup-or-create popover); TaskList; TaskEditPopup; TaskNotePopover
