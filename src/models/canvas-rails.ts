...
export type SlotKind = 'lens' | 'notes' | 'calendar' | 'taskboard' | 'horizons' | 'status' | 'scoreboard' | 'snoozeGraveyard'
...
export const SLOT_KINDS: readonly SlotKind[] = ['lens', 'notes', 'calendar', 'taskboard', 'horizons', 'status', 'scoreboard', 'snoozeGraveyard']
